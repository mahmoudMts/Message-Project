...
@JsonTypeName("associatedMarketDetails")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2024-02-05T14:26:08.215951400+05:30[Asia/Calcutta]")
public class AssociatedMarketDetails implements Serializable {
  ...
  public AssociatedMarketDetails pseudonym(String pseudonym) {
    this.pseudonym = pseudonym;
    return this;
  }

  /**
   * pseudonym of the London Market
   * @return pseudonym
  */
  ...
  public AssociatedMarketDetails partyReference(String partyReference) {
  ...
  */
  ...
  public AssociatedMarketDetails partyId(UUID partyId) {
  ...
  */
  ...
  public AssociatedMarketDetails partyMarketId(UUID partyMarketId) {
  ...
  */
  ...
  public AssociatedMarketDetails regulatoryJurisdiction(RegulatoryJurisdictionEnum regulatoryJurisdiction) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    AssociatedMarketDetails associatedMarketDetails = (AssociatedMarketDetails) o;
    return Objects.equals(this.pseudonym, associatedMarketDetails.pseudonym) &&
        Objects.equals(this.partyReference, associatedMarketDetails.partyReference) &&
        Objects.equals(this.partyId, associatedMarketDetails.partyId) &&
        Objects.equals(this.partyMarketId, associatedMarketDetails.partyMarketId) &&
        Objects.equals(this.regulatoryJurisdiction, associatedMarketDetails.regulatoryJurisdiction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pseudonym, partyReference, partyId, partyMarketId, regulatoryJurisdiction);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AssociatedMarketDetails {\n");
