...
public class InterchangeHeaderUNB {
     ...
     */
    @JsonProperty("dateTimeOfPreparation")
    public String getDateTimeOfPreparation() {
     ...
     */
    @JsonProperty("dateTimeOfPreparation")
    public void setDateTimeOfPreparation(String dateTimeOfPreparation) {
    ...
    public enum TestIndicator {
        ...
        private final static Map<String, InterchangeHeaderUNB.TestIndicator> CONSTANTS = new HashMap<String, InterchangeHeaderUNB.TestIndicator>();

        static {
            for (InterchangeHeaderUNB.TestIndicator c: values()) {
                CONSTANTS.put(c.value, c);
            }
        }

        TestIndicator(String value) {
            this.value = value;
        }
        ...
        @JsonCreator
        public static InterchangeHeaderUNB.TestIndicator fromValue(String value) {
        	InterchangeHeaderUNB.TestIndicator constant = CONSTANTS.get(value);
            if (constant == null) {
